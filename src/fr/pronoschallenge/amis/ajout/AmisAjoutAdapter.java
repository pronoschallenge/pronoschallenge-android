        ...
        if (amisAjoutEntry != null) {
            ...
            pseudoCheckBox.setOnClickListener(new View.OnClickListener() {
                public void onClick(View checkBoxView) {
                    ...
                    // mise Ã  jour de la valeur de l'objet amisAjoutEntry pour que les boutons
                    // reprennent un Ã©tat correct si il disparraissent de l'Ã©cran puis rÃ©apparraissent
